<<<<<<< HEAD
function [cost, grad, CNN, preds, vrijeme] = cnnCost(images, labels, theta, CNN, pred)
...
if(size(labels_full, 1) < CNN.numClasses)
    labels_full(CNN.numClasses, CNN.minibatchSize) = 0;
end
